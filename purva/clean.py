...
_BOILERPLATE = [
    ...
    re.compile(r"ओपन बुक्स|ओ\s+बी\s+ओ|ओबीओ|डाट कॉम|OBO"),
    re.compile(r"आमंत्रण भेजे|नियम देखे|अनिवार्य है|रन करा दे|दर्ज करने हेतु"),
    re.compile(r"विज्ञापन योजना|सुझाव एवं शिकायत"),
    re.compile(r"ग़ज़ल से सम्बंधित|मात्रा गणना|तकतीअ|बहर परिचय|बहर के भेद"),
    re.compile(r"प्रबन्धन|वर्जित है"),
    re.compile(r"^दि०|^\d-"),
]
